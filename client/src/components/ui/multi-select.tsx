            ...
            {[...selectedValues]
                ...
                .map(value => (
                    <Badge
                        variant="outline"
                        data-selected-item
                        className="group flex items-center gap-1 wrap-break-word text-[11px]"
                        key={value}
                        onClick={
                            clickToRemove
                                ? e => {
...
export function MultiSelectContent({
    ...
    return (
        <>
            ...
            <PopoverContent className="border border-gray-300 min-w-(--radix-popover-trigger-width) p-0">
                <Command {...props} className="border-b border-gray-300">
                    {canSearch ? (
                        <CommandInput
                            placeholder={
